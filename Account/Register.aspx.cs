...
public partial class Account_Register : Page
{
    protected void CreateUser_Click(object sender, EventArgs e)
    {
        ...
        if (result.Succeeded)
        {
            ...
            string sql = "Insert INTO [CentricUsers] ([userId], [firstName], [lastName], [Twitter], [HireDate], [Title], [Department]) Values (@userID, @firstName, @lastName, @twitter, @HireDate, @title, @department)";
            ...
            comNewUse.Parameters.Add("@department", System.Data.SqlDbType.NVarChar, 50).Value = department.Text;
            try
            {
                conUsers.Open();
