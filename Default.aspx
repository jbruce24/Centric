        ...
        <div class="row">
            <div class="box" >
                <div class="col-lg-12" style="left: 6px; top: -10px">
                    <div class="col-md-4">
                        <table class="nav-justified" style ="color: azure">
                            <tr>
                                <td> 
...
<a href="https://twitter.com/intent/tweet?screen_name=centric" style="float:right"  class="twitter-mention-button" data-size="large">Tweet to @centric</a></td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
                    </div>    
