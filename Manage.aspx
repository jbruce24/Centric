   ...
   <div class="box">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:FormView runat="server" ID="fvUserProf" DataKeyNames="userID" DataSourceID="sqlForm">
                <EditItemTemplate>
                    userID:
                    ...
                    <br />
                    twitter:
                    <asp:TextBox ID="twitterTextBox" runat="server" Text='<%# Bind("twitter") %>' />
                    <br />
                    firstName:
                ...
                <ItemTemplate>
                    ...
                    <br />
                    twitter:
                    <asp:Label ID="twitterLabel" runat="server" Text='<%# Bind("twitter") %>' />
                    <br />
                    firstName:
            ...
            <asp:SqlDataSource ID="sqlForm" runat="server" ConnectionString="<%$ ConnectionStrings:CSUserData %>" SelectCommand="SELECT [userID], [lastName], [twitter], [firstName], [HireDate], [title], [department], [region] FROM [CentricUsers]"></asp:SqlDataSource>
